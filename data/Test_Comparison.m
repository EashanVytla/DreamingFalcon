...
normoutput = csvread('testSequenceOutput4-12.csv');
...
%un_norm_data = rewards_test * 50 - 25;

un_norm_data = rewards_val * 1;

figure

plot(output(:,1),'r','DisplayName','W');
hold on
plot(output(:,2),'g','DisplayName','X');
hold on
plot(output(:,3),'b','DisplayName','Y');
hold on
plot(output(:,4),'m','DisplayName','Z');
title('Model Predictions IMU')
legend

figure
plot(un_norm_data(:,1),'r','DisplayName','X');
hold on
plot(un_norm_data(:,2),'g','DisplayName','Y');
hold on
plot(un_norm_data(:,3),'b','DisplayName','Z');
hold on
plot(un_norm_data(:,4),'m','DisplayName','Z');
